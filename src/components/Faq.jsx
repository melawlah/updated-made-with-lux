...
//   const defaultFaqList = t("faq", { returnObjects: true });
//   const cityFaqList = t(`cityPage.${city}.faq`, {
//     returnObjects: true,
//     defaultValue: [],
//   });

//   const faqList = cityFaqList.length > 0 ? cityFaqList : defaultFaqList;

//   const [openIndex, setOpenIndex] = useState(null);
//   const toggle = (index) => setOpenIndex(openIndex === index ? null : index);

// console.log("CITY:", city);
// console.log("City FAQ List:", cityFaqList);
...
//     <section id="faq" className="py-24 px-4 md:px-8 bg-gradient-to-b from-white to-gray-50">
//       <div className="max-w-4xl mx-auto text-center mb-16">
//         <h2 className="text-4xl md:text-5xl font-bold mt-2">{faqTitle}</h2>
//         <p className="text-md sm:text-lg md:text-xl leading-relaxed text-gray-700 font-light max-w-3xl mt-4 mx-auto">
//           {faqIntro}
//         </p>
//       </div>
...
const FAQ = ({ cityOverrides = {} }) => {
  const { t } = useTranslation();

  const faqTitle = t("faqTitle");
  const faqIntro = t("faqIntro");

  const faqList = cityOverrides.faq || t("faq", { returnObjects: true });
